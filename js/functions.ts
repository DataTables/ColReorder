 ...
 */
export function arrayMove(arr: any[], from: number, count: number, to: number): void {
 ...
 */
export function finalise(dt: Api) {
 ...
 * the columns.
 */
export function headerUpdate(structure: any[], map: number[], from: number[], to: number): void {
 ...
 */
export function invertKeyValues(arr: number[]): number[] {
	let result = [];
 ...
 */
export function setOrder(dt: Api, order: number[], original: boolean): void {
	let changed = false;
	let i;
 ...
 */
export function structureFill(structure: HeaderStructure[][]) {
 ...
 */
export function validateMove(table: Api<any>, from: number[], to: number) {
 ...
 * @returns
 */
export function validateStructureMove(structure: HeaderStructure[][], from: number[], to: number): boolean {
